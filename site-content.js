window.siteContent = {
  ...
  navigation: {
    desktop: ["Кейсы", "Услуги", "Процесс", "Обсудить задачу"],
    mobile: ["Кейсы", "Услуги", "Процесс", "Обсудить задачу"],
    menuToggle: "Открыть меню",
    modalClose: "Закрыть"
  },
  opening: {
    eyebrow: "System Design · AI · Automation",
    titleHtml: "Усиливаем бизнес<br>не количеством людей,<br>а <span class=\"title-accent\">качеством систем.</span>",
    lead: "Проектируем AI-инструменты, автоматизацию и внутренние процессы так, чтобы команда работала быстрее, точнее и спокойнее — без перегруза и хаотичного масштабирования.",
    actions: ["Запросить разбор", "Посмотреть кейсы"],
    stats: [
      { label: "Фокус", value: "AI + внутренние системы" },
      { label: "Подход", value: "От аудита к внедрению" },
      { label: "Результат", value: "Меньше ручной работы" }
    ]
  },
  heroPanels: [
    "Вы построили бизнес. Затем начали масштабироваться и нанимать сотрудников.",
    "Поиск, собеседования, адаптация. Каждый новый сотрудник — это время и деньги, а увольнение всегда сложный и затратный процесс.",
    "Рост упирается в команду. Проще усилить текущих людей, чем постоянно расширять штат."
  ],
  intro: {
